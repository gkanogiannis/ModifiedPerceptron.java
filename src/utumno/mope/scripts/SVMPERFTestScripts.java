/*
 *
 * ModifiedPerceptron.java utumno.mope.scripts.SVMPERFTestScripts
 *
...
public class SVMPERFTestScripts {
			...
			for(String dataset : datasets){
				...
				for(String className : classesNames){
					if(linuxMode){
						...
						String command = exe + "\"" + prefix + prefix2 + "test"+fileSeparator + className + ".test.svmf\" " + "\"" + prefix + prefix2 + "train"+fileSeparator + className + ".svmperf.model\" "+ "\"" + prefix + prefix2 + "test"+fileSeparator + className + ".svmperf.pred\" " +"1>"+ "\"" + prefix + prefix2 + "test"+fileSeparator + className + ".test.svmperf.txt\" " + (linuxMode?";":"");
						bw.write(command + (linuxMode?"":"\r") +"\n");
					}
				}
