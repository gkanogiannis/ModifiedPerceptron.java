/*
 *
 * ModifiedPerceptron.java utumno.mope.scripts.POI
 *
...
public class POI {
	...
	public static void main(String[] args) {
		String[] datasets = {"reuters-10","reuters-10-x","reuters-90","reuters-90-x",
	             ...
	             "reutersSingle-8",
	             "reutersSingle-52",
	             "reutersBIG-103","reutersBIGIn-354","reutersBIGRe-366"
				 };
		...
		//RHCPP
		try {
			FileInputStream fis = new FileInputStream(new File(prefix0,"results-TC(RHCPP-RH-SVMPERF-BaPe).xls"));
		...
		try {
			fileOut = new FileOutputStream(new File(prefix0,"results-TC(RHCPP-RH-SVMPERF-BaPe).xls"));
			wb.write(fileOut);
		    fileOut.close();
		} 
		catch (Exception e) {
