/*
 *
 * ModifiedPerceptron.java utumno.mope.scripts.BatchPerceptronMicroMacroScripts
 *
...
public class BatchPerceptronMicroMacroScripts {
	...
	public static void main(String[] args) {
		...
		String exe    = " java -classpath \""+prefix+"rh.jar\" utumno.rothyp.utils.BatchPerceptronMicroMacroResults ";
		
		String fileSeparator = linuxMode? "/" : "\\";
		
		BufferedWriter bw = null;
		try {
			bw = new BufferedWriter(new FileWriter(prefix0+"batchperceptron-mm."+(linuxMode?"sh":"bat")));
			for(String dataset : datasets){
				...
				String command = exe + "\"" + prefix + prefix2 + "\" 1>\""+prefix + prefix2 + fileSeparator + dataset +".bape.mm.txt\""+ (linuxMode?";":"");
