/*
 *
 * ModifiedPerceptron.java utumno.mope.utils.MoPeMicroMacroResults
 *
...
public class MoPeMicroMacroResults {
	...
	public static void main(String[] args) {
		...
		try{
			...
			for(File f : files){
				if(f.getName().endsWith(".test.mope.txt")){
					i++;
		...
		try{
			...
			for(File f : files){
				if(f.getName().endsWith(".train.mope.txt")){
					i++;
					BufferedReader br = new BufferedReader(new FileReader(f));
					br.readLine();br.readLine();br.readLine();br.readLine();br.readLine();
