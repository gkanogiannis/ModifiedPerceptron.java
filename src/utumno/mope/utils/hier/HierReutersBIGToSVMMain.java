/*
 *
 * ModifiedPerceptron.java utumno.mope.utils.hier.HierReutersBIGToSVMMain
 *
...
public class HierReutersBIGToSVMMain {
	...
	public HierReutersBIGToSVMMain(String dataInFileName){
		try{
	...
	public static void main(String[] args) {
		HierReutersBIGToSVMMain main = new HierReutersBIGToSVMMain(args[0]);
		main.buildTree();
		main.showTree();
		main.evaluate();
		//main.evaluateFlat();
